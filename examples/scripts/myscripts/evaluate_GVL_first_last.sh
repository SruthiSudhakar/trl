#!/usr/bin/env bash
set -euo pipefail
# usage: ./examples/scripts/myscripts/evaluate_GVL.sh

# ==========================
# Defaults (can be overridden)
# ==========================
DEFAULT_CUDA_DEVICES="2,3,4,5,6,7"   # comma-separated, e.g. "0,1,2,3"
...
run_one() {
  ...
  echo "=================================================="
  CUDA_VISIBLE_DEVICES="${gpu}" python3 examples/scripts/myscripts/evaluate_GVL_first_last.py \
