...
for dir in "${dirs[@]}"; do
  # ls /workspace/guided_diffusion_policy/data/outputs/jan19/2026.01.19/20.04.49_clip_allPnP/checkpoints/epoch_120_step_40897/na_na_16_expert_fulltask_${dir}/overlay_images_binary/dataset_cache_train_1__4_8_12_16__True_True.pkl
  du -sh /workspace/guided_diffusion_policy/data/outputs/jan19/2026.01.19/20.04.49_clip_allPnP/checkpoints/epoch_120_step_40897/na_na_16_expert_fulltask_${dir}/overlay_images_binary/dataset_cache_train_1__4_8_12_16__True_True.pkl
